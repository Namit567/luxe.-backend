...
async function downloadImage(imageUrl: any, outputPath: any) {
...
// Function to upload images along with title and price
async function uploadImages(uploadUrl: any, images: any, title: any, price: any, category: any) {
    ...
    form.append('price', getRandomInt(900, 2000).toString());
    form.append('stock', getRandomInt(10, 100).toString());
...
async function processItem(item: any, uploadApiUrl: any, tempDir: any) {
    try {
        const downloadedImages = [];
        // for (const imageUrl of item.images) {
        let imageUrl = item.images[0];
        const outputImagePath = path.join(tempDir, path.basename(imageUrl));
        await downloadImage(imageUrl, outputImagePath);
        downloadedImages.push(outputImagePath);
        // }

        const result = await uploadImages(uploadApiUrl, downloadedImages, item.title, item.price, item.category.name);
        console.log('Images uploaded successfully:', result);

        // Clean up the downloaded files
        downloadedImages.forEach(fs.unlinkSync);
    } catch (error) {
        console.error('Error processing item:', error);
    }
}

// Function to process the list of items
export async function processItems(items: any, uploadApiUrl: any) {
    ...
    try {
        for (const item of items) {
            await processItem(item, uploadApiUrl, tempDir);
        }
    } catch (error) {
    } finally {
...
export const items = [
    {
        ...
        "creationAt": "2024-05-18T03:16:57.000Z",
        "updatedAt": "2024-05-18T06:14:16.000Z",
        "category": {
            "id": 1,
            "name": "Clothes",
            "image": "https://i.imgur.com/QkIa5tT.jpeg",
            "creationAt": "2024-05-18T03:16:57.000Z",
            "updatedAt": "2024-05-18T03:16:57.000Z"
        }
    },
    {
        "id": 6,
    ...
    },
    {
        ...
        "creationAt": "2024-05-18T03:16:57.000Z",
        "updatedAt": "2024-05-18T04:08:59.000Z",
        "category": {
            "id": 1,
            "name": "Clothes",
            "image": "https://i.imgur.com/QkIa5tT.jpeg",
    ...
    },
    {
        ...
        "title": "Saco Burberry",
        "price": 1500,
        "description": "Buso de marca",
        "images": [
            "https://i.imgur.com/QkIa5tT.jpeg"
        ],
        "creationAt": "2024-05-18T08:13:44.000Z",
        "updatedAt": "2024-05-18T08:13:44.000Z",
        "category": {
            "id": 1,
            "name": "Clothes",
            "image": "https://i.imgur.com/QkIa5tT.jpeg",
...
// const uploadApiUrl = 'http://localhost:4000/api/v1/product/new?id=yIPK207X5yP332kQByMUVQhZKAa2'; // Replace with your upload URL
export const uploadApiUrl = 'https://luxe-api.onrender.com/api/v1/product/new?id=yIPK207X5yP332kQByMUVQhZKAa2'; // Replace with your upload URL

// module.exports = {processItem, items, uploadApiUrl};
